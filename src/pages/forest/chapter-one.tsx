      ...
      <MaxContainer>
        <ContentContainer>
          ...
          <LockContentWrapper>
            ...
            <LockItem>Chapter I</LockItem>
            <LockTitle>Your journey has begun.</LockTitle>
            <LockDesc css={{ ...fadeInAnimation(1.5) }}>
              Every forest branch moves differently in the breeze, <br /> but as
              they sway they connect at the roots.
              <br />— Rumi
            </LockDesc>

            <Button
              style={{ marginTop: "30px" }}
              onClick={() => router.push(PAGE.FOREST_MIDNIGHT_MASS)}
            >
              Next
            </Button>
          </LockContentWrapper>
