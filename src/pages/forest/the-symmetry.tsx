...
const TheSymmetry = () => {
  ...
  const { data, isLoading } = useQuery(
    ...
    },
    {
      ...
      enabled: sessionData.progress > 14,
  ...
  useEffect(() => {
    const isReadyForNextStep = sessionData.progress > 15
    if (isReadyForNextStep) {
      router.push(PAGE.FOREST_PALISADES_OF_REALITY)
    }
  ...
  useEffect(() => {
    router.prefetch(PAGE.FOREST_PALISADES_OF_REALITY)
  }, [router])
