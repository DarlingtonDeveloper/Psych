...
const Two = () => {
  ...
  const { data, isLoading } = useQuery(
    ...
    },
    {
      ...
      enabled: sessionData.progress > 16 && sessionData.progress < 18,
  ...
  useEffect(() => {
    const isReadyForNextStep = sessionData.progress > 17
    if (isReadyForNextStep) {
      router.push(PAGE.FOREST_THE_LIGHT)
    }
  ...
  useEffect(() => {
    router.prefetch(PAGE.FOREST_THE_LIGHT)
  }, [router])
